...
class BitVector : public BitString<std::vector<uint8_t>> {
	public:
		/** Creates an empty bit vector. */
		BitVector() : BitString<std::vector<uint8_t>>() { }
		/** Creates a bit vector to hold n bits. */
		BitVector(size_t n) : BitString<std::vector<uint8_t>>() {
