...
class Bijection {
    ...
    typedef typename DMap::map_type::const_iterator const_iterator;
    typedef typename DMap::map_type::value_type value_type;
    typedef const value_type& const_reference;
    typedef typename DMap::map_type::size_type size_type;
