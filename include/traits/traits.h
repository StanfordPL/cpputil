...
template <typename Key, typename T, typename Hash, typename Eq, typename Alloc>
struct is_stl_container<std::unordered_multiset<Key, T, Hash, Eq, Alloc>> : public std::true_type {};
...
template <typename T>
struct is_stl_unordered_associative : public std::false_type {};

template <typename Key, typename T, typename Hash, typename Eq, typename Alloc>
struct is_stl_unordered_associative<std::unordered_map<Key, T, Hash, Eq, Alloc>> : public std::true_type {};

template <typename Key, typename Hash, typename Eq, typename Alloc>
struct is_stl_unordered_associative<std::unordered_set<Key, Hash, Eq, Alloc>> : public std::true_type {};

template <typename Key, typename T, typename Hash, typename Eq, typename Alloc>
struct is_stl_unordered_associative<std::unordered_multimap<Key, T, Hash, Eq, Alloc>> : public std::true_type {};

template <typename Key, typename T, typename Hash, typename Eq, typename Alloc>
struct is_stl_unordered_associative<std::unordered_multiset<Key, T, Hash, Eq, Alloc>> : public std::true_type {};
